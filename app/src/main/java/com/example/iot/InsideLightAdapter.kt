...
class InsideLightAdapter(private val lightList: MutableList<InsideLightModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder.itemViewType) {
            ...
            VIEW_TYPE_ITEM -> {
                val lightHolder = holder as InsideLightsViewHolder
    ...
    class InsideLightsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun updateData(newList: List<InsideLightModel>) {
